...
Les fonctions exécutives reposent principalement sur le **cortex préfrontal**, qui les met en œuvre en interaction avec d'autres régions cérébrales. Sur le plan clinique et neuropsychologique, on les définit généralement autour de trois capacités fondamentales, à partir desquelles dérivent les autres :

**L'inhibition**, soit la capacité à retenir une réponse automatique ou impulsive pour agir de façon réfléchie.
