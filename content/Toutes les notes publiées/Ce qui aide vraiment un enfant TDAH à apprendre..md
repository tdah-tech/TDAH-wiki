...
publish: true
created: 2026-07-22
modified: 2026-07-27T11:53:05.100+02:00
tags:
  - micronote
  - tdah
  - scolarité
...
| Technique                                  | Description                                                                                                                                                        | Niveau de preuve |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- |
| **Test de pratique (récupération active)** | Se tester soi-même sur le contenu plutôt que le relire passivement. Se tester sur le matériel à apprendre (flashcards, questions de fin de chapitre, rappel libre) | **Élevé**        |
| **Pratique distribuée (espacement)**       | Répartir les sessions d'étude dans le temps plutôt que les concentrer                                                                                              | **Élevé**        |
| **Auto-explication**                       | Expliquer comment une information nouvelle se relie à ce qu'on sait déjà                                                                                           | Modéré           |
| **Interrogation élaborative**              | Se demander et expliquer pourquoi un fait ou un concept est vrai                                                                                                   | Modéré           |
| **Pratique entrelacée**                    | Mélanger différents types de problèmes dans une même séance                                                                                                        | Modéré           |
| Relecture                                  | Relire un texte une seconde fois                                                                                                                                   | Faible           |
| Surlignage / soulignage                    | Marquer les passages jugés importants                                                                                                                              | Faible           |
...
C'est la question qui mérite d'être posée avant d'aller plus loin, et la réponse est rassurante.

Les études postérieures à 2013 ont exploré plus spécifiquement l'efficacité de la récupération active chez les personnes atteintes de TDAH :

1. **Un bénéfice comparable aux témoins.** Knouse et ses collègues (2016) ont montré que les étudiants universitaires avec TDAH bénéficient autant de la récupération active que les étudiants sans TDAH lorsque l'usage de cette technique est contrôlé par l'expérimentateur. Dans leur étude, les deux groupes ont appris des listes de mots avec soit des opportunités de réétude, soit des essais de récupération entrelacés, et ont été testés après deux jours. Le bénéfice du testage était comparable dans les deux groupes.
...
**Porter la méthode avant de l'exiger en autonomie.** Comme pour les autres compétences, le contrôle doit se transférer progressivement du parent vers l'enfant, jamais d'un coup. Au départ, c'est l'adulte qui initie les moments de récupération active et qui gère l'espacement dans le temps ; l'enfant reprend cette responsabilité par étapes, à mesure qu'il en démontre la capacité.

**Garder l'espacement simple.** Pas de système sophistiqué de répétition à gérer par l'enfant seul au départ : revoir une notion deux jours après suffit pour commencer, avant d'introduire une planification plus élaborée.

**Combiner avec un encodage plus profond.** Puisque la difficulté spécifique chez l'enfant TDAH notamment non médicamenté concerne la qualité de l'encodage initial plutôt que la récupération elle-même, associer la récupération active à des moments d'auto-explication (« comment tu as trouvé cette réponse ? ») renforce le maillon le plus fragile de la chaîne.

**Récompenser l'effort de récupération lui-même.** En s'appuyant sur les principes de [[Bien calibrer le renforcement positif|renforcement positif]] (spécificité, immédiateté, fréquence), féliciter concrètement l'enfant pour l'effort de se tester, pas seulement pour la bonne réponse, construit la motivation à répéter la démarche.
