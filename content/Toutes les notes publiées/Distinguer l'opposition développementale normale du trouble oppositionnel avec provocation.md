...
publish: true
created: 2026-07-22
modified: 2026-08-07T10:22:15.857+02:00
tags:
  - micronote
  - tdah
  - trouble-opposition
...
**L'intensité et le nombre de symptômes.** Le DSM-5 requiert au moins quatre symptômes parmi trois catégories : l'humeur colérique et irritable, le comportement argumentatif et provocateur, et l'esprit vindicatif. Un enfant qui présente un seul de ces traits de façon isolée, même de manière marquée, ne remplit pas les critères. C'est la combinaison et l'accumulation qui comptent, pas un trait isolé aussi frappant soit-il.

**Le contexte et la généralisation.** Ces comportements doivent se manifester durant l'interaction avec au moins un individu extérieur à la fratrie, ce qui exclut d'emblée les simples conflits de rivalité fraternelle, très fréquents et généralement sans lien avec un trouble. Par ailleurs, plus le comportement s'étend à de nombreux contextes différents (maison, école, activités extrascolaires, avec plusieurs adultes différents), plus il s'éloigne d'une réaction ponctuelle à une situation ou une personne précise pour se rapprocher d'un pattern généralisé.
...
Le risque, une fois l'étiquette posée, c'est de relire systématiquement tout comportement de l'enfant à travers le prisme du diagnostic : chaque refus devient "son TOP qui ressort", chaque bouderie devient un symptôme à noter. Cette lecture univoque est non seulement inexacte cliniquement, mais elle rejoint aussi directement le [[Trouble de l'opposition et image de soi|problème d'étiquette et d'image de soi]] : un enfant à qui on renvoie que même ses réactions les plus banales sont des manifestations pathologiques finit par intégrer qu'il n'a plus de comportement "normal" possible, que tout de lui est symptôme. Ça alimente exactement la fusion entre trouble et identité qu'on cherche à éviter.

Garder à l'esprit qu'un enfant TOP reste, la majorité du temps, un enfant qui vit des oppositions ordinaires liées à son âge permet de continuer à distinguer, au quotidien, ce qui relève du trouble et nécessite une réponse spécifique, de ce qui relève simplement du fait d'être un enfant, et qui n'appelle rien de plus qu'une réponse parentale habituelle.
