...
L'idée est d'externaliser la succession des étapes et de tenir compte que les enfants TDAH ont [[Consignes orales simples|une vulnérabilité spécifique pour traiter les consignes données par le canal verbal]].

Avec un support visuel l’enfant n’a plus à retenir l’ordre des actions et peut simplement se référer au support visuel.
...
Ces faiblesses n’annulent pas l’intérêt des supports visuels. Elles rappellent simplement qu’ils constituent un outil parmi d’autres, à combiner avec d'autres outils. Utilisés avec discernement, ils peuvent faciliter la [[Mettre en place des routines|mise en place des routines]], allèger la charge exécutive pendant l'exécution de ces dernières mais utilisés de façon isolée ou mécanique, ils risquent de décevoir après quelques jours ou semaines.

## Références :

Thomas, N., et al., (2022), The efficacy of visual activity schedule intervention in reducing problem behaviors in children with attention-deficit/hyperactivity disorder between the age of 5 and 12 years: A systematic review, Journal of the Korean Academy of Child and Adolescent Psychiatry, 33(1), 2–15
