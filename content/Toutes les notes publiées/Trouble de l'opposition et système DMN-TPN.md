...
publish: true
created: 2026-07-22
modified: 2026-08-07T11:00:39.130+02:00
tags:
  - micronote
  - tdah
  - dmn
...
Chez un cerveau TDAH, cette bascule est plus coûteuse et moins fiable, et c'est précisément à ce moment de transition que naissent une grande partie des conflits du quotidien. Comprendre ce lien change la façon d'intervenir : au lieu de traiter l'opposition comme un problème de discipline, on peut agir sur son véritable point de départ, la transition elle-même.

#### Comment la bascule neurologique nourrit le cycle oppositionnel

**À l'instant où on demande à l'enfant de démarrer une tâche, son cerveau doit désengager le mode par défaut (DMN) pour engager le mode d'attention dirigée (TPN), et cette bascule ne se fait pas automatiquement. Le "attends" voire le "non" ou la "négociation" réflexe est souvent la manifestation de cette friction, pas un refus pensé**.
...
Le point clé, **c'est que l'origine du problème est neurologique et ponctuelle (la bascule [[Le modèle TPN-DMN|DMN-TPN]] coûte cher à cet instant précis), mais que son entretien devient relationnel et durable (le conflit qui suit devient une habitude comportementale indépendante de la transition elle-même)**.

C'est pour cette raison qu'agir uniquement sur le plan comportemental, avec des sanctions ou des rappels à l'ordre, ne résout rien : ça n'adresse jamais le vrai déclencheur, qui est ce moment de bascule attentionnelle. Réduire la fréquence et l'intensité de ces frictions à la source réduit mécaniquement le nombre d'occasions où le cycle oppositionnel peut s'amorcer.
