...
Le concept central qui unit ces données est donc celui d'un **décalage évolutif**. Le cerveau humain a été façonné pour un monde qui n’existe presque plus. **Les traits qui aidaient à survivre dans la savane ou la forêt sont devenus sources de friction dans une société qui demande de rester assis, de suivre des horaires fixes et de maintenir une attention prolongée sur des tâches abstraites**.

Cela  permet d'appréhender les difficultés des TDAH non comme des défauts mais comme le résultat d’un **décalage entre un cerveau façonné par des centaines de milliers d’années d’exploration et les exigences d’un environnement radicalement transformé depuis quelques milliers d’années seulement**.
