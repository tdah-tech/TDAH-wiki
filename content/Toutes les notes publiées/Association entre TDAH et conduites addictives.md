...
Concernant le traitement, la science a progressé de façon significative. **Le [[Le méthylphénidate comme traitement du TDAH|traitement pharmacologique]] du TDAH, notamment par des stimulants à libération prolongée (méthylphénidate), n’augmente pas le risque de développer une addiction chez les patients sans antécédent addictif ; plusieurs données longitudinales suggèrent même un effet protecteur lorsqu’il est instauré précocement et de manière continue**.
