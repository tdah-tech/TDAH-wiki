...
**L’intelligence musicale**, fondée sur la sensibilité aux rythmes, aux hauteurs et aux structures sonores, n’apparaît pas spécifiquement diminuée.

**L’intelligence corporelle-kinesthésique**, liée à la maîtrise du corps et au mouvement, peut même se trouver renforcée par le besoin d’activité physique caractéristique de nombreux profils hyperactifs. L’intelligence naturaliste, celle qui permet de reconnaître et de classer les éléments du vivant et de l’environnement, ne présente pas non plus de lien particulier avec le trouble. Quant à l’intelligence existentielle, elle demeure en dehors des données comparatives actuelles.

Le tableau suivant synthétise ces observations à partir des travaux cités de Najafi et al. (2017).

| Intelligence               | Impact du TDAH                  |
| -------------------------- | ------------------------------- |
| Linguistique               | Non significatif                |
| Logico-mathématique        | Touchée (souvent diminuée)      |
| Spatiale                   | Non significatif                |
| Musicale                   | Non significatif                |
| Corporelle-kinesthésique   | Non significatif                |
| Interpersonnelle           | Touchée (souvent diminuée)      |
| Intrapersonnelle           | Touchée (souvent diminuée)      |
| Naturaliste                | Non significatif                |
| Existentielle (parfois 9e) | Non étudiée de façon spécifique |

Ces constats ne doivent pas être lus comme des fatalités.

La grande variabilité individuelle demeure la règle. Certains développent des forces marquées dans les domaines spatiaux, musicaux ou kinesthésiques précisément parce que le fonctionnement cérébral atypique du TDAH favorise la [[Les TDAH pensent-ils vraiment plus vite ?|pensée divergente]], l’[[Qu'est-ce-que l'hyperfocus ?|hyperfocalisation]] sur les sujets d’intérêt ou une sensibilité sensorielle particulière.
