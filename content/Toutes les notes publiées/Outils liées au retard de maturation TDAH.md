...
2. **Renforcer les échafaudages externes (scaffolding)** — Le pilier le mieux validé de cette liste :
...
4. **Interventions améliorant le fonctionnement préfrontal malgré le retard**
   ...
   - **Entraînement des [[Les fonctions éxécutives - définition|fonctions exécutives]]** (Cogmed, inhibition) : gains réels sur les tâches entraînées, mais transfert faible vers les fonctions académiques ou l'attention en vie réelle. Mieux maintenu combiné aux stratégies environnementales.
